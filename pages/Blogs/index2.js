...
const index2 = () => {
  return (
    ...
    <div className="flex flex-col items-center m-8">
      ...
      >
        <div
          className="snap-start w-full h-full flex items-center justify-center text-white text-4xl font-bold flex-shrink-0 bg-[#1369AF]"
          id="slide-1"
        >
          Blogs
        </div>
        ...
        <div className="container flex justify-between mx-auto">
          <div className="w-full lg:w-8/12">
            <div className="flex items-center justify-between">
              ...
              <div>
                <select className="w-full border-gray-100 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
